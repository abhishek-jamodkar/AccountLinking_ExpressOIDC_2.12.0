...
class Auth0Client {
    ...
    async getToken() {
        ...
        const opts = {
            ...
            json: {
                ...
                audience: `${process.env.MGM_API_URL}`,
            },
        };
    ...
    async getUser(userId) {
        ...
        return await this.request({
            url: `${process.env.MGM_API_URL}users/${userId}`,
        });
    }
    ...
    async getUsersWithSameVerifiedEmail({ sub, email }) {
        ...
        return await this.request({
            url: `${process.env.MGM_API_URL}users`,
            qs: {
                search_engine: "v3",
    ...
    async linkAccounts(rootUserId, targetUserIdToken) {
        debug("linking...");
        return await this.request({
            url: `${process.env.MGM_API_URL}users/${rootUserId}/identities`,
            method: "POST",
            json: {
